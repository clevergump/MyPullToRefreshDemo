...
import com.clevergump.my_pulltorefresh_demo.widget.header.PtrHeaderLayout1;
 ...
 * @author clevergump
 */
public class PullToRefreshLayout7 extends LinearLayout {
    ...
    private PtrHeaderBaseLayout7 mHeaderView;


    public PullToRefreshLayout7(Context context) {
        this(context, null);
    }

    public PullToRefreshLayout7(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PullToRefreshLayout7(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @return
     */
    public PtrHeaderBaseLayout7 getPtrHeaderView() {
        PtrHeaderBaseLayout7 headerView = new PtrHeaderLayout1(mContext);
     ...
     * @param headerView
     */
    public void setPtrHeaderView(PtrHeaderBaseLayout7 headerView) {
        if (headerView == null) {
            return;
        }
