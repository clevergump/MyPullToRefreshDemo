 ...
 * @author clevergump
 */
public class PtrHeaderLayout7_1 extends PtrHeaderBaseLayout7_1 {
    ...
    public PtrHeaderLayout7_1(Context context) {
        this(context, null);
    }

    public PtrHeaderLayout7_1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PtrHeaderLayout7_1(Context context, AttributeSet attrs, int defStyleAttr) {
